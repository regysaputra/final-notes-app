...
export default function Navbar(props) {
    ...
    // console.log("Navbar props auth = ", props.auth);
    return (
        <header>
            <h1>
                <Link to="/">
            ...
            <nav
                className={props.auth === null ? "hidden-button" : "navigation"}
            >
                <ul>
                    <li>
                        <Link to="/archives">
            ...
            <button
                ...
                className={
                    props.auth === null ? "hidden-button" : "button-logout"
                }
            >
                <svg
                    stroke="currentColor"
                ...
                {props.auth !== null && props.auth.name}
            </button>
        </header>
    );
}
